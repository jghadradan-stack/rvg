...
* 🔌 **حالت نود + API مستر**: این پنل مستر نیست؛ API توکن‌دار دارد تا به یک پنل مستر دیگر وصل شود و از آنجا کانفیگ‌ها و آمار مدیریت شوند
...
## 🖥️ اتصال این RVG به پنل مستر

این سرویس یک **نود** است، نه پنل مستر. پنل مستر از طریق API توکن‌دار به این نود وصل می‌شود.
